...
int main(int argc, char* argv[])
{
    ...
    IntervalVectorVar box_simp_out(4);
    IntervalVector& w_simp_out = cn_simplified_out.create_interm_var(IntervalVector(4));
    Interval& beta_simp_out = cn_simplified_out.create_interm_var(Interval());
    ...
    ctc_cn ctc_cn_out(&cn_simplified_out, &box_simp_out);


    ContractorNetwork cn_simplified_in;
    IntervalVectorVar box_simp_in(4);
    IntervalVector& w_simp_in = cn_simplified_in.create_interm_var(IntervalVector(4));
    Interval& beta_simp_in = cn_simplified_in.create_interm_var(Interval());
    ...
    ctc_cn ctc_cn_in(&cn_simplified_in, &box_simp_in);
